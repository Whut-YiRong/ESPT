...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, drop_rate=0.1, drop_block=False,
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, n_blocks, drop_rate=0.1, dropblock_size=5, max_pool=True):
